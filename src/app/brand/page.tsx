  ...
  return (
    <div className="bg-white border border-border py-6 px-6 rounded-2xl flex-1">
      ...
      <div className="border border-[#E5E7EB] rounded-xl p-[33px]">
        ...
        <Checkbox className="checked:bg-red-500" />
      </div>
      ...
      <div className="border border-[#E5E7EB] rounded-xl p-[33px]">
        ...
        <div className="flex flex-col gap-4">
          {typographyScale.map((scale) => (
            <div className="p-[17px] rounded-lg cursor-pointer border border-[##E5E7EB] flex justify-between items-center">
      ...
      <div className="mt-[21px] flex gap-4 justify-end rounded-lg">
        ...
        <button className="text-white font-semibold py-[9px] px-3 gradient-bg rounded-lg">
          Save Changes
        </button>
      </div>
    </div>
